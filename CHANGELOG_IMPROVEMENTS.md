# CHANGELOG - RHTTP.IO IMPROVEMENTS v2.0
...
```typescript
// BEFORE: Didn't work
const { data: t } = await http.poll("/", { polling: { interval: 3_000, maxAttempts: 5 } });
// t was undefined, code after didn't execute

// AFTER: Works correctly
const { data } = await http.poll("/", { polling: { interval: 3_000, maxAttempts: 5 } });
